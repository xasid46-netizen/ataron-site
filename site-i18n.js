  ...
  const dictionaries = {
    ...
    he: {
      ...
      home: {
        ...
        featuresCards: [["פרויקטים", "כל אתר נשמר כפרויקט נפרד עם כתובת, סטטוס, משתתפים והיסטוריה."], ["תמונות מהאתר", "התמונות מקושרות לפרויקט ומאפשרות לתעד שלבי עבודה."], ["מסמכים ותוכניות", "PDF, תמונות וקבצי פרויקט מרוכזים במקום אחד וזמינים לצוות."], ["צ'אט פרויקט", "שאלות לקבלן, לאדריכל, למנהל העבודה ולעובדים נשארות בתוך הפרויקט."], ["הערות", "חומרים, שאלות ללקוח, בדיקות והחלטות אדריכל נרשמים במהירות."], ["קוד QR לפרויקט", "אפשר להציב QR באתר כדי לפתוח במהירות את כרטיס הפרויקט."]],
    ...
    ar: {
      ...
      home: {
        ...
        featuresCards: [["المشاريع", "كل موقع محفوظ كمشروع مستقل مع العنوان والحالة والمشاركين والتاريخ."], ["صور الموقع", "الصور مرتبطة بالمشروع وتساعد على توثيق مراحل العمل."], ["المستندات والمخططات", "ملفات PDF والصور وملفات المشروع محفوظة في مكان واحد ومتاحة للفريق."], ["دردشة المشروع", "أسئلة المقاول والمهندس والمشرف والعمال تبقى داخل المشروع."], ["الملاحظات", "المواد والأسئلة والفحوصات وقرارات المهندس تُسجل بسرعة."], ["رمز QR للمشروع", "يمكن وضع رمز QR في الموقع لفتح بطاقة المشروع بسرعة."]],
        audienceEyebrow: "لمن",
